            ...
            <div className="flex flex-col gap-6 animate-in slide-in-from-bottom-4 fade-in duration-400">
              ...
              <div className="flex flex-col gap-3 mt-2 mb-6">
                <div className="flex justify-between items-center px-1">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${isAlertActive ? 'bg-emerald-500' : 'bg-default-300'}`}
                    >
                      <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${isAlertActive ? 'translate-x-4' : 'translate-x-1'}`} />
                    </button>
                  </label>
                </div>
                
                <div className="grid grid-cols-2 gap-3 bg-content2/50 border border-black/5 dark:border-white/5 p-4 rounded-2xl">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input 
                      ...
                      className="w-full bg-content1 border border-black/10 dark:border-white/10 rounded-lg px-3 py-2 text-sm outline-none focus:border-primary transition-colors text-cyan-500 font-bold"
                    />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input 
                      ...
                      className="w-full bg-content1 border border-black/10 dark:border-white/10 rounded-lg px-3 py-2 text-sm outline-none focus:border-primary transition-colors text-fuchsia-500 font-bold"
                    />
                  </div>
                </div>
                ...
                <button 
                  ...
                  className={`w-full py-3 rounded-xl font-bold transition-all ${alertSuccess ? 'bg-emerald-500 text-white' : 'bg-primary text-white hover:bg-primary/90'} ${savingAlert ? 'opacity-70 cursor-not-allowed' : ''}`}
                >
